      ...
      <div className="order-1 lg:order-2 space-y-8">
        <section 
          ...
          className={cn(
            ...
            isDownloading ? "p-8 bg-gradient-to-b from-surface to-background border-primary/20 shadow-2xl shadow-primary/10" : ""
          )}
        >
          ...
          {/* Footer Branding */}
          {isDownloading && (
            <div className="mt-8 pt-6 border-t border-border/50 text-center flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-text-muted/70">braintwin.app</span>
            </div>
          )}
        </section>
      </div>
